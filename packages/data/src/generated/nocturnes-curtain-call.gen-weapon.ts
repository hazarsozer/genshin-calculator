...
// Nocturne's Curtain Call (gameId 14522) — 5★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14522.json).
...
export const NocturnesCurtainCallStatTable: readonly StatTableEntry[] = [
