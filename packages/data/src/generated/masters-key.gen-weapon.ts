...
// Master Key (gameId 12433) — 4★ claymore
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/12433.json).
...
export const MastersKeyStatTable: readonly StatTableEntry[] = [
