...
// Blackmarrow Lantern (gameId 14433) — 4★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14433.json).
...
export const BlackmarrowLanternStatTable: readonly StatTableEntry[] = [
  entry("atk_base", 41.0671, atk_2_4, new StatTable([25.9, 51.9, 77.8, 103.7, 129.7, 155.6])),
  entry("mastery_base", 48, crt_2_1),
];
