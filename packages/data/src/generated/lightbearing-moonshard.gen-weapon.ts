...
// Lightbearing Moonshard (gameId 11519) — 5★ sword
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/11519.json).
...
export const LightbearingMoonshardStatTable: readonly StatTableEntry[] = [
