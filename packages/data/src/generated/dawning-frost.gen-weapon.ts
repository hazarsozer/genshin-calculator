...
// Dawning Frost (gameId 14434) — 4★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14434.json).
...
export const DawningFrostStatTable: readonly StatTableEntry[] = [
