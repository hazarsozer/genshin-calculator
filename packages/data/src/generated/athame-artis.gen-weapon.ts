...
// Athame Artis (gameId 11518) — 5★ sword
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/11518.json).
...
export const AthameArtisStatTable: readonly StatTableEntry[] = [
