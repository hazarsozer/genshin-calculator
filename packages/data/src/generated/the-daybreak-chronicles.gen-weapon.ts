...
// The Daybreak Chronicles (gameId 15515) — 5★ bow
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/15515.json).
...
export const TheDaybreakChroniclesStatTable: readonly StatTableEntry[] = [
