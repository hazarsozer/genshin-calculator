...
// Rainbow Serpent's Rain Bow (gameId 15434) — 4★ bow
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/15434.json).
...
export const RainbowSerpentsRainBowStatTable: readonly StatTableEntry[] = [
  entry("atk_base", 42.401, atk_2_1, new StatTable([25.9, 51.9, 77.8, 103.7, 129.7, 155.6])),
  entry("recharge_base", 10, crt_2_1),
];
