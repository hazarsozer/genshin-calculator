...
// Etherlight Spindlelute (gameId 14432) — 4★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14432.json).
...
export const EtherlightSpindleluteStatTable: readonly StatTableEntry[] = [
