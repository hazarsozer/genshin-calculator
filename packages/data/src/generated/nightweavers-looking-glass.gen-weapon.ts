...
// Nightweaver's Looking Glass (gameId 14520) — 5★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14520.json).
...
export const NightweaversLookingGlassStatTable: readonly StatTableEntry[] = [
