...
// Reliquary of Truth (gameId 14521) — 5★ catalyst
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/14521.json).
...
export const ReliquaryOfTruthStatTable: readonly StatTableEntry[] = [
