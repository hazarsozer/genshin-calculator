...
// Snare Hook (gameId 15433) — 4★ bow
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/15433.json).
...
export const SnareHookStatTable: readonly StatTableEntry[] = [
