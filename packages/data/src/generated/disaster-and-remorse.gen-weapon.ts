...
// Disaster and Remorse (gameId 13517) — 5★ polearm
// Numbers from Project Amber (pinned: tools/port/_fixtures/ambr/weapon/13517.json).
...
export const DisasterAndRemorseStatTable: readonly StatTableEntry[] = [
