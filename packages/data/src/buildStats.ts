...
const RAW_BAG_SCALING_KEYS = [
  ...
  "yunjin_def_total",     // Yun Jin Flying Cloud Flag Formation DEF-scaled normal-DMG multiplier (P3.5.2 Bucket C)
  "yunjin_char_skill_burst", // Yun Jin burst talent level lift (leveling key for the multiplier)
