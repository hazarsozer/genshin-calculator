 ...
 *
 * Currently EMPTY: jahoda + durin were promoted to characters/ on 2026-06-18; nefer (the first GO-gated
 * char) on 2026-06-17. The next v6 chars (Zibai/Illuga/… — see tools/port/live-chars.json) stage here as
 * they're gated. */
export {};
